          ...
          <div class="card-body">
            <div v-if="!registered">
              <div class="form-group">
                ...
                <input
                  id="privateKey"
                  v-model="before.input.privateKey"
                  type="text"
                  class="form-control"
              ...
              <div class="form-group">
                ...
                <input
                  id="startDate"
                  v-model="before.input.startDate"
                  type="text"
                  class="form-control"
                  placeholder="yyyy-MM-dd HH:mm:ss, 예: 2019-04-21 21:00:00"
                />
              </div>
              <div class="form-group">
                ...
                <input
                  id="untilDate"
                  v-model="before.input.untilDate"
                  type="text"
                  class="form-control"
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  >{{ isCreatingContract ? "계약을 생성하는 중입니다." : "경매 등록하기" }}</button>
                </div>
            ...
            <div v-if="registered">
              <div class="alert alert-success" role="alert">경매가 생성되었습니다.</div>
...
export default {
  ...
  methods: {
    ...
    register: function() {
      ...
      // 1. 내 지갑 주소를 가져옵니다.
      this.$walletService.findAddressById(this.sharedStates.user.id, function(
        walletAddress
      ) {
        ...
        createAuction(
          ...
          function(auctionContract) {
            var contractAddress = auctionContract;
            ...
            // 3. 선택한 작업 정보를 가져옵니다.
            this.$workService.findById(scope.before.selectedWork, function(result) {
              scope.after.work = result;
            });

            // 4. 생성한 경매를 등록 요청 합니다.
            this.$auctionService.register(data, function(result) {
              alert("경매가 등록되었습니다.");
  ...
  mounted: function() {
    ...
    // 내 작품 목록 가져오기
    this.$workService.findWorksByOwner(this.sharedStates.user.id, function(result) {
